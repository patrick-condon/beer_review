...
describe Beer do
  describe ".new" do
    it "takes a name, brewery name, style, and abv" do
      beer = Beer.new(beer_name: "Miller lite", brewery_name: "Coors", beer_style: "American Pilsner", beer_abv: 4.2)
      expect(beer).to be_a(Beer)
    end
  end

  let(:beer) { Beer.create(beer_name: "Miller lite", brewery_name: "Coors", beer_style: "American Pilsner", beer_abv: 4.2) }
